    ...
    <div className="divide-y divide-gray-100 dark:divide-gray-700">
      ...
      <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        ...
        <div className="prose max-w-none prose-lg pt-8 pb-7 dark:prose-invert xl:col-span-2">
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut soluta assumenda quo quidem enim perferendis quia blanditiis perspiciatis earum minima.
          </p>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut ex obcaecati voluptatibus ipsa est esse repellendus, deleniti expedita soluta labore aliquid consectetur tempora velit aliquam repellat.
          </p>
          <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Natus vero dignissimos velit quidem mollitia, esse iure placeat eius iusto, dicta a quod laudantium distinctio vel.
          </p>
        </div>
      </div>
    </div>
